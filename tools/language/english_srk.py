...
xdauser_q = "What is your XDA username (use "guest" if you don't have one) ?"
...
update_finished_win = "superr1.exe in the kitchen directory can be ignored or deleted."
update_finished_win2 = "It will be removed automatically the next time the kitchen exits"
update_finished_win3 = "and starts again."
...
# Language
reset_language = "Language has been reset. Changes will be made"
reset_language2 = "the next time you start the kitchen"
