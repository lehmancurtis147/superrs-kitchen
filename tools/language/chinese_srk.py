...
menu_extra_dir = "解压目录选项"
menu_rom_debloat = "Debloat选项"
menu_build_menu = "生成ROM"

# Startup
startup_project = "CURRENT PROJECT: "
startup_version = "ANDROID版本: "
startup_mdepend = "缺少的依赖: "
startup_need_java = "需要至少jre8以上版本运行"
startup_copy_extract = "复制firmware到项目"
startup_copy_extract2 = "directory and choose option 4 to extract it."
startup_title_no_rom = "没有ROM"
startup_no_projects = "There is no project to work on."
startup_prep_updater_script = "准备 updater-script ..."
startup_no_rom = "There is no ROM to work on."
startup_srkuser = "确定你的kitchen账号 (非邮箱):"
startup_srkuser_pass = "Kitchen密码: "
...
startup_srkuser_error5 = "注册kitchen账号"
startup_srkuser_q = "这是你的kitchen账号?  y/n"
startup_srkpass_q = "保存密码?  y/n"
startup_error = "安装时发生了一些错误. 尝试重新安装"
startup_checksum = "The following checksums did not match:"

# Build
menu_build_zip = "Build full ROM Zip"
menu_sys_img = "生成img文件"
menu_sign = "为导出的zip包签名"
donate_menu_zipalign = "使用Zipalign优化apk文件"
donate_menu_custom_id = "自定义 ro.build.display.id"
menu_custom_zip = "自定义zip菜单"
...
build_prep_img = "为生成img准备文件"
build_check_ziplog = "发生了一些错误. 检测日志zip.log"
build_prep_sys_img = "为生成EXT4 img准备文件"
build_img_error = "生成镜像时发生了一个错误"
build_img_which = "你想生成哪个img文件"
build_img_nocon = "无法找到 file_contexts 文件"
build_img_nocon2 = "确定 boot.img 在项目目录"
build_img_nocon3 = "或者复制 file_contexts 到项目目录下的 00_project_files 文件夹"
build_img_nocon4 = "重新尝试"
build_no_zip = "没有zip用来签名"
build_no_boot_q = "Your ROM does not contain a boot.img or kernel.img/ramdisk.img."
build_no_boot_q2 = "无论如何都要继续?  y/n"
build_cho_zip = "选择ZIP:"
zipalign_q = "再生成zip之前使用zipalign优化?  y/n  "
zipalign = "Zipalign优化中"
zipalign_frame_q = "使用 zipalign 优化 /framework 的apk文件?  y/n  "
zipalign_complete = "Zipalign优化完成"
...
bloat_q = "Would you like to debloat your ROM?  y/n  "
bloat_knoz_rem_q = "Would you like remove Knox?  y/n  "
...
menu_ubinary = "Flashable zip options"
...
title_ubinary = "Flashable zip options for "
...
metasize = "Short/Long set_metadata updater-script (global)"
metasize_s = "Short"
metasize_l = "Long"
...
deodex_problems2 = "and will cause issues if you flash the ROM."
...
extract_fail = "Something went wrong wiith the extraction."
...
zipdev_building = "生成设备刷机包 ..."
zipdev_uploading = "提交到服务器 ..."
zipdev_finished = "刷机包创建成功:"
zipdev_upload = "将文件上传至服务器"
zipdev_upload2 = "让你的数据可以被别人使用?  y/n"
support_upload = "Would you like to upload your support zip now?  y/n"
xdauser_q = "输入你的XDA名称 (没有就输入"ghost") ?"
zipdev_no_new = "没有新的设备在你的设备目录"

# Kitchen updater
update_check_kitchen = "检查更新中 ..."
update_down = "文件服务器暂时关闭."
update_down2 = "请重新尝试."
update_update_avail = "发现新版本"
update_update_cv = "当前版本: "
update_update_nv = "最新版本: "
update_update_now = "现在更新"
update_update_view = "查看更新日志"
update_changelog = "更新日志 (最近3个版本):"
update_updating = "更新中 ..."
update_finished = "更新完毕，请重新启动"
update_finished_win = "可以删除目录中的superr1.exe"
update_finished_win2 = "退出Kitchen或下次启动时"
update_finished_win3 = "它将会被自动删除"
update_already = "当前已是最新版本"
update_check_launcher = "检查启动器更新"
update_launcher_avail = "发现新的启动器版本"
update_launcher_cv = "当前版本:"
update_launcher_nv = "最新版本:"
update_launcher_finished = "启动器更新成功"
update_problem_download = "下载更新时发生错误"
update_no_internet = "网络错误"
update_fail = "更新时发生了错误"
update_fail2 = "请重新更新"
update_fail3 = ":("
update_q = "现在更新?  y/n  "
update_auto_q = "在启动时检查更新?  y/n  "
update_auto_toggle = "在启动时更新"
update_cred_fail = "服务器无法找到你的凭证"
update_cred_fail2 = "请下载最新版本进行注册"
update_cred_fail3 = "注册网址:"
update_reg_address = "https://sr-code.com/reg.php"
update_verify = "验证 checksums ..."
...
# Sign
sign_ram_check = "检测剩余内存 ..."
sign_no_ram = "没有足够的内存"
sign_signing = "签名中 "
sign_signed = "签名成功"
sign_fail = "签名时发生了一些错误"
sign_q = "签名这个zip文件?  y/n  "

# Build img
img_add = "添加中 "
img_flash_fail = "这个刷机包不能使用"
img_flash_fail2 = "因为没有分区信息在"
img_create_dat = "创建 sparse dat 镜像在"
img_create_symlinks = "创建 symlinks 在"
img_create_raw = "生成中 "
img_fail = "生成镜像时发生了一些错误"
img_fail2 = "Make sure your partition size is correct and"
img_fail3 = "that the directory is not too big to fit."
...
img_sparse_q = "生成什么类型的system.img"

# Language
reset_language = "语言文件加载成功"
reset_language2 = "将会在下次启动载入"
lang_added = "New English language elements have been added to "
lang_translate = "确保翻译文件正确"

# Tools
tools_dl = "下载中 "
tools_dl_failed = "下载失败的工具:"
tools_dl_install_failed = "工具 下载/安装 失败."
tools_dl_device_failed = "无法下载设备数据"
tools_dl_device_failed2 = "进入 Misc Tools > 获取设备数据"
tools_dl_device_failed3 = "来获得最新版本"
wintools_dl = "下载了 17MB 数据)"
lintools_dl = "下载了 24MB 数据)"
tools_need = "在继续前你需要下载工具"
tools_dl_install = "下载/安装 中 ..."
tools_dl_q = "现在下载/安装它们?  y/n  "
